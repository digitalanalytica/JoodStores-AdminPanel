...
<!-- Image Fit Field -->
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            ...
            <div class="form-text text-muted">{{ trans("lang.slide_product_id_help") }}</div>
        </div>
    </div>
...
<div class="form-group col-12 text-right">
    ...
    <a href="{!! route('slider3.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
