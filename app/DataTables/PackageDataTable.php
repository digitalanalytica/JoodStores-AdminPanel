...
class PackageDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'monthly_price',
                'title' => trans('lang.package_monthly_price'),

            ],
            [
                'data' => 'six_month_price',
                'title' => trans('lang.package_six_month_price'),

            ],
            [
                'data' => 'one_year_price',
                'title' => trans('lang.package_one_year_price'),

            ],
            [
                'data' => 'number_of_ads',
                'title' => trans('lang.package_number_of_ads'),

            ],
            [
                'data' => 'status',
                'title' => trans('lang.package_status'),

            ],

            [
                'data' => 'updated_at',
                'title' => trans('lang.package_updated_at'),
                'searchable' => false,
            ]
        ];
